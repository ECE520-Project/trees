...
impl<T: Ord + Copy + fmt::Debug> AVLTreeNode<T> {
    ...
    // /// Delete a node
    // fn delete(&mut self, mut node: AVLTreeNode<T>, data:T) {
    ...
    //         Ordering::Less => {
    //             if let Some(successor) = node.right.take() {
    //                 node.right = delete(data, successor);
    //                 node.update_height();
    //                 node.rebalance();
    //             }
    //         },
    ...
    //         Ordering::Greater => {
    //             if let Some(successor) = node.left.take() {
    //                 node.left = delete(data, successor);
    //                 node.update_height();
    //                 node.rebalance();
    //             }
    //         },
    ...
    //                 let leftmost_node = parent_left_node.left.take().unwrap();
